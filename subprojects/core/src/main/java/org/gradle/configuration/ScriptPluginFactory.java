...
public interface ScriptPluginFactory {
    ...
    ScriptPlugin create(ScriptSource scriptSource, ScriptHandler scriptHandler, ClassLoaderScope targetScope, ClassLoaderScope baseScope, RootBuildPluginResolver rootBuildPluginResolver);
}
